...
def train(net, optimizer, lossfunc, train_iter, test_iter, device, num_epochs, is_pretrained=True):
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch+1) % 20 == 0:
            ...
            torch.save(net.state_dict(), f'./model/{modelname}_epoch{epoch+1}.pt')
...
if __name__ == '__main__':
    train_accs, train_losss, test_accs, test_losss = train(net, optimizer, criterion, trainloader, testloader, device,
                                                           num_epochs, is_pretrained=True)
